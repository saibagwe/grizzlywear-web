...
export const MOCK_ADDRESSES: Address[] = [
  {
    ...
    name: 'Brian Ambrose',
    phone: '7304967959',
    line1: '4th Floor, 40, Parshu Ram Patil Building',
    line2: 'Station Road, Kalyan',
    city: 'Thane',
    state: 'Maharashtra',
    pincode: '421201',
    isDefault: true
  },
  {
    ...
    name: 'Brian Ambrose',
    phone: '7304967959',
    line1: 'Coworking Space, B Wing, 2nd Floor',
...
// Helper to reliably grab a product for mock orders
const getProduct = (id: string) => MOCK_PRODUCTS.find(p => p.id === id) || MOCK_PRODUCTS[0];
...
export const MOCK_ORDERS: Order[] = [
  {
    ...
    status: 'pending',
    items: [
      { product: getProduct('prod-m-01'), size: 'L', color: 'Onyx Black', quantity: 1 },
    ],
    total: 3499,
  ...
  },
  {
    ...
    status: 'shipped',
    items: [
      { product: getProduct('prod-w-02'), size: 'M', color: 'Charcoal', quantity: 1 },
      { product: getProduct('prod-w-06'), size: 'M', color: 'White', quantity: 1 }
    ],
    total: 3898, // 2899 + 999
    trackingId: '782910384729',
  ...
  },
  {
    ...
    status: 'delivered',
    items: [
      { product: getProduct('prod-m-02'), size: 'M', color: 'Olive', quantity: 1 },
      { product: getProduct('prod-a-04'), size: 'L/XL', color: 'Multi', quantity: 2 }
    ],
    total: 5697, // 4299 + (699 * 2)
  ...
  },
  {
    ...
    status: 'cancelled',
    items: [
      { product: getProduct('prod-a-01'), size: 'OS', color: 'Black/White', quantity: 1 },
    ],
    total: 899,
    deliveryAddress: MOCK_ADDRESSES[0]
  }
