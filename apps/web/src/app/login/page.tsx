      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500">
            Sign in to your Grizzlywear account
          </p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 border border-gray-300 px-4 py-3.5 text-sm font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 mb-6"
        >
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label htmlFor="password" className="block text-xs tracking-wider uppercase text-gray-600">
                Password
              </label>
