      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-sm text-gray-500 uppercase tracking-widest">
            Premium fashion for the fearless. {MOCK_PRODUCTS.length} total products.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 min-w-0">
            {/* Top Bar for Sort and Active Filters */}
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 text-center border border-gray-100">
                ...
                <p className="text-gray-500 mb-8 max-w-md mx-auto">Try adjusting your filters or search terms to find what you&apos;re looking for.</p>
                <button 
